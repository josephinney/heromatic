...
const Apps: React.FC = () => {
  ...
  return (
    <main className="overflow-hidden pt-16 pb-44 max-md:pb-24">
      <div className="flex flex-col items-center w-full max-md:max-w-full">
        {/* Header - Mantiene su posición en ambos layouts */}
        <header className="flex flex-col max-w-full text-center w-[572px] max-md:w-full px-5">
          <h1 className="self-center text-4xl font-bold leading-10 bg-clip-text gradient-title max-md:max-w-full">
            Control Your Operations from Anywhere
          </h1>
          <h2 className="mt-4 text-base font-semibold leading-loose text-neutral-950 max-md:max-w-full">
        ...
        {/* Section container con flexbox para cambiar dirección en móvil */}
        <section className="flex relative items-start px-60 mt-10 w-full max-md:px-5 max-md:flex-col max-md:items-center">
          {/* Imagen - en escritorio está posicionada absolutamente, en móvil pasa a ser un elemento normal del flujo */}
          <div className="hidden max-md:block max-md:w-full max-md:mb-10 max-md:mt-8">
            <img
              onMouseEnter={() => setHovered(true)}
              onMouseLeave={() => setHovered(false)}
              src={
          ...
          {/* Contenido de texto */}
          <article className="flex z-0 flex-col h-[435px] min-w-60 w-[488px] max-md:h-auto max-md:w-full max-md:text-center">
            <div className="w-full max-md:max-w-full">
              <h2 className="text-4xl leading-10 uppercase text-neutral-700 max-md:max-w-full">
                <span className="font-bold text-[#363636]">
                  Shaping the future{" "}
            ...
            <button
              className="flex gap-2 items-center self-start px-4 py-2 mt-16 text-2xl leading-snug text-center capitalize bg-white border-t-2 border-solid border-t-[#3BA1E0] text-neutral-950 hover:bg-gray-50 transition-colors max-md:mt-10 max-md:self-center"
            >
              <span className="self-stretch my-auto">Contact Us</span>
              <img
                src="https://cdn.builder.io/api/v1/image/assets/cc725807c14044218a044f65b2af1b69/5d372f28c760df22286a26f3dcebb235a121549e?placeholderIfAbsent=true"
          ...
          {/* Imagen para versión desktop - oculta en móvil */}
          <img 
            onMouseEnter={() => setHovered(true)} 
            onMouseLeave={() => setHovered(false)}
            src={
            ...
            alt="IoT devices control illustration"
            className="object-contain absolute right-18 z-0 aspect-[1.73] bottom-[-5px] h-[441px] min-w-60 w-[763px] max-md:hidden"
          />
        </section>
      </div>
    </main>
