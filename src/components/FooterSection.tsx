...
//     return (
//         <footer className="bg-[#3BA1E0] px-4 py-16">
//             <div className="flex flex-col items-center gap-12 text-white max-md:px-4">

//                 {/* Input + Botón */}
//                 <div className="flex items-center bg-white px-4 py-2 shadow-md w-full max-w-md">
...
//                         className="flex-1 ml-2 text-sm text-[#3BA1E0] placeholder-[#3BA1E0] border-none outline-none bg-transparent"
//                     />
//                     <button className="bg-[#3BA1E0] text-white text-sm px-4 py-1.5 hover:bg-[#2a7fb2] transition">
//                         More Info
...
//                             key={platform}
//                             href="#"
//                             className="flex items-center gap-2 px-4 py-2 text-sm font-semibold border border-white rounded-full text-white hover:bg-white hover:text-[#3BA1E0] transition"
//                         >
//                             <div className="w-4 h-4 border border-white rounded bg-transparent"></div>
//                             {platform}
//                         </a>
//                     ))}
//                 </nav>
...
//                 {/* Línea divisoria */}
//                 <div className="w-full h-px bg-white max-w-5xl" />

//                 {/* Copyright */}
//                 <p className="text-xs tracking-wide uppercase text-white text-center">
                ...
                <section className="flex flex-col gap-6 items-center">
                    <div className="flex gap-72 items-center py-1.5 pr-1.5 pl-3 bg-white rounded-lg max-md:gap-5 max-md:w-[90%] max-sm:flex-col max-sm:gap-2.5 max-sm:p-2.5">
                        <div className="flex gap-2 items-center max-sm:w-full">
                            ...
                            <span className="text-xs tracking-wide leading-5 text-[#3BA1E0]">
                                Your email
                            </span>
                        </div>
