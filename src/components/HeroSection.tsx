...
//       <div className="absolute inset-0 z-0 overflow-hidden">
//         <video
//           className="absolute w-auto min-w-full min-h-full max-w-none object-cover left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 scale-100"
//           autoPlay
//           muted
//           loop
//         >
  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <video
          className={`
            absolute w-auto min-w-full min-h-full max-w-none object-cover 
            ${isMobile ? "" : "left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"}
          `}
          style={isMobile ? { left: -625.66, top: -43.65 } : undefined}
          autoPlay
          muted
          loop
        >
